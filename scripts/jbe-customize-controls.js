...
(function ($) {
  ...
  wp.customize.bind("ready", function () {
    function hideGradientControls() {
      ...
      if (
        wp.customize.instance("jgd_bizelite_enable_gradients").get() === true
      ) {
    ...
    function hideFullPageBGControl() {
      if (
        wp.customize.instance("jgd_bizelite_full_page_enable_bg").get() === true
      ) {
    ...
    function hideLandingPageOptions1() {
      var lPControlIds1 = [
        ...
        "jgd_bizelite_show_landing_fg_gutenberg_1",
      ...
      if (
        wp.customize.instance("jgd_bizelite_select_landing_page").get() !==
        "lp_one"
      ) {
    ...
    function hideLandingPageOptions2() {
      var lPControlIds2 = [
        ...
        "jgd_bizelite_show_landing_fg_gutenberg_2",
    ...
    function hideLandingPageOptions3() {
      var lPControlIds3 = [
        ...
        "jgd_bizelite_show_landing_fg_gutenberg_3",
    ...
    function loadLanding1Url() {
      ...
      if (
        ...
        var url;
        pageId = wp.customize
          .instance("jgd_bizelite_apply_landing_page_1")
          .get();
    ...
    function loadLanding2Url() {
      if (
        ...
        var url;
        pageId = wp.customize
          .instance("jgd_bizelite_apply_landing_page_2")
          .get();
    ...
    function loadLanding3Url() {
      if (
        ...
        var url;
        pageId = wp.customize
          .instance("jgd_bizelite_apply_landing_page_3")
          .get();
    ...
    // and on Change
    $("#customize-control-jgd_bizelite_enable_gradients").on(
      "change",
      hideGradientControls,
    );
    $("#customize-control-jgd_bizelite_full_page_enable_bg").on(
      "change",
      hideFullPageBGControl,
    );
    $("#customize-control-jgd_bizelite_select_landing_page").on(
      "change",
      hideLandingPageOptions1,
    );
    $("#customize-control-jgd_bizelite_select_landing_page").on(
