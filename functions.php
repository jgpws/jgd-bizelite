...
function jgd_bizelite_enqueue_scripts()
{
    wp_register_script(
        ...
        array('jquery'),
        filemtime(get_template_directory() . '/scripts/jgd-bizelite-scripts.min.js'),
        true
    );
...
require get_template_directory() . '/options/jgd_bizelite_customizer.php';

require get_template_directory() . '/options/jgd_bizelite_customizer-frontend.php';
