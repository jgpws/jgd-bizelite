...
function jgd_bizelite_category_icon() {
	$use_icons = get_theme_mod( 'jgd_bizelite_use_icons' );
	if( $use_icons == 1 ) { ?>
		<strong><span class="ti-folder" title="<?php esc_attr_e( 'Posted in categories:', 'jgd-bizelite' ); ?>"><span class="screen-reader-text"><?php _e( 'Posted in categories:', 'jgd-bizelite' ); ?></span></span> :</strong><?php the_category(', '); ?>
	<?php
	} else { ?>
